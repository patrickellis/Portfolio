(function () {
    ...
    define("config", ["modernizr", "libs/device"], function (t, e) {
        var i = {
            SITE_URL: "http://",
            APP_URL: "https://apps.facebook.com/",
            CDN: "./20210115022720_1_0_6b70b98",
            ENV: "live",
            SOUND_MUTED: !1,
            ...
            MIN_WIDTH: 950,
            MIN_HEIGHT: 500,
            SCALE: { BASE_FONTSIZE: 10, MIN_FONTSIZE: 6, LARGE_FONTSIZE: 10, MAX_FONTSIZE: 12, BASE_COLUMNS: 12, PROJECT_COLUMNS: 8, BASE_WIDTH: 1536, LARGE_WIDTH: 2048, MAX_WIDTH: 2560 },
            ...
            BRIGHTNESS_EFFECT: !1,
            TEXT_EFFECT: !0,
            FLOWS: { BASIC: "BASIC", EXTENDED: "EXTENDED", MOBILE: "MOBILE", MOBILE_BASIC: "MOBILE_BASIC", TABLET: "TABLET" },
            FLOW: "none",
            FLASH_VESRION: "11.0.0",
            FLASH: null,
            FLASH_BYPASS: window.location.href.match(/bypass/),
            FACEBOOK_APP_IDS: { live: "", staging: "", dev: "", local: "205547496221381" },
    ...
    define("events/app_events", [], function () {
        return {
            Scale: { Change: "events:scale:change" },
            Video: {
            ...
            Menu: { Active: "menu:active", ItemClick: "menu:itemclick", Over: "MENU:OVER", Out: "MENU:OUT" },
            Project: { Active: "project:active", Scroll: "project:scroll", Update: "project:update" },
            Work: { PreUpdate: "work:preupdate" },
            Shell: {
            ...
            Gem: { ShowText: "gem:showtext" },
            Loader: { PreLoad: "LOADER:PRE", PostLoad: "LOADER:POST", Complete: "LOADER:COMPLETE", Hidden: "LOADER:HIDDEN", PreHidden: "LOADER:PREHIDDEN", AnimateBarOut: "loader:animatebarout" },
            Interactives: { Show: "INTERACTIVES:SHOW", Hide: "INTERACTIVES:HIDE" },
            Resize: { Attached: "resize:attached", Detached: "resize:detached", TriggerSound: "resize:triggersound", UpdateSound: "resize:updatesound", KillSound: "resize:killsound" },
    ...
    function () {
        ...
        (v.each = v.forEach = function (t, e, i) {
            e = y(e, i);
            var n, r;
            if (k(t)) for (n = 0, r = t.length; n < r; n++) e(t[n], n, t);
            else {
                var s = v.keys(t);
        ...
        (v.keys = function (t) {
            ...
            (v.findKey = function (t, e, i) {
                e = x(e, i);
                for (var n, r = v.keys(t), s = 0, o = r.length; s < o; s++) if (((n = r[s]), e(t[n], n, t))) return n;
            }),
        ...
        var D = function (t, e, i, n) {
            ...
            if ((i.push(t), n.push(e), s)) {
                ...
                for (; l--; ) if (!D(t[l], e[l], i, n)) return !1;
            } else {
                var u,
                    h = v.keys(t);
                if (((l = h.length), v.keys(e).length !== l)) return !1;
                for (; l--; ) if (((u = h[l]), !v.has(e, u) || !D(t[u], e[u], i, n))) return !1;
            }
    ...
    (function (t, e) {
        ...
        function s(t) {
            var e = (ft[t] = {});
            return (
                J.each(t.match(ct) || [], function (t, i) {
                    e[i] = !0;
                }),
                e
            );
        ...
        function g(t, e) {
            ...
            if (1 === e.nodeType) {
                if (mt.hasData(t) && ((s = mt.access(t)), (o = mt.set(e, s)), (u = s.events))) {
                    ...
                    for (r in u) for (i = 0, n = u[r].length; i < n; i++) J.event.add(e, r, u[r][i]);
                }
        ...
        function x(t) {
            ...
            return (
                i ||
                    ((i = y(t, e)),
                    ("none" !== i && i) || ((Lt = (Lt || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement)), (e = Lt[0].contentDocument), e.write(), e.close(), (i = y(t, e)), Lt.detach()),
                    (It[t] = i)),
                i
            );
        }
        function b(t, e, i) {
            ...
            return (
                ...
                i &&
                    ...
                    Bt.test(o) && Ft.test(e) && ((n = a.width), (r = a.minWidth), (s = a.maxWidth), (a.minWidth = a.maxWidth = a.width = o), (o = i.width), (a.width = n), (a.minWidth = r), (a.maxWidth = s))),
                void 0 !== o ? o + "" : o
            );
        }
        function w(t, e) {
        ...
        function T(t, e) {
            if (e in t) return e;
            for (var i = e[0].toUpperCase() + e.slice(1), n = e, r = Ut.length; r--; ) if ((e = Ut[r] + i) in t) return e;
            return n;
        }
        function S(t, e, i) {
            var n = qt.exec(e);
        ...
        function P(t, e, i, n, r) {
            for (var s = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, o = 0; s < 4; s += 2)
                "margin" === i && (o += J.css(t, i + xt[s], !0, r)),
                    n
                        ? ("content" === i && (o -= J.css(t, "padding" + xt[s], !0, r)), "margin" !== i && (o -= J.css(t, "border" + xt[s] + "Width", !0, r)))
                        : ((o += J.css(t, "padding" + xt[s], !0, r)), "padding" !== i && (o += J.css(t, "border" + xt[s] + "Width", !0, r)));
            return o;
        }
        function k(t, e, i) {
            var n = !0,
        ...
        function C(t, e) {
            for (var i, n, r, s = [], o = 0, a = t.length; o < a; o++)
                (n = t[o]),
                    n.style &&
                        ((s[o] = mt.get(n, "olddisplay")),
                        (i = n.style.display),
                        e
                            ? (s[o] || "none" !== i || (n.style.display = ""), "" === n.style.display && bt(n) && (s[o] = mt.access(n, "olddisplay", x(n.nodeName))))
                            : ((r = bt(n)), ("none" === i && r) || mt.set(n, "olddisplay", r ? i : J.css(n, "display"))));
        ...
        function R(t, e, i) {
            for (var n, r = (Kt[e] || []).concat(Kt["*"]), s = 0, o = r.length; s < o; s++) if ((n = r[s].call(i, e, t))) return n;
        }
        function D(t, e, i) {
            var n,
                r,
            ...
            i.queue ||
                ...
                1 === t.nodeType &&
                    ...
                    (u = J.css(t, "display")),
                    "inline" === ("none" === u ? mt.get(t, "olddisplay") || x(t.nodeName) : u) && "none" === J.css(t, "float") && (f.display = "inline-block")),
                i.overflow &&
                    ((f.overflow = "hidden"),
                    h.always(function () {
            ...
            if (J.isEmptyObject(c)) "inline" === ("none" === u ? x(t.nodeName) : u) && (f.display = u);
                ...
                d ? "hidden" in d && (p = d.hidden) : (d = mt.access(t, "fxshow", {})),
                    s && (d.hidden = !p),
                    p
                        ? J(t).show()
                        : h.done(function () {
        ...
        function M(t, e, i) {
            var n,
                ...
                h = u.props;
            for (N(h, u.opts.specialEasing); s < o; s++) if ((n = Jt[s].call(u, t, h, u.opts))) return n;
            return (
                J.map(h, R, u),
        ...
        function j(t) {
            return function (e, i) {
                ...
                if (J.isFunction(i)) for (; (n = s[r++]); ) "+" === n[0] ? ((n = n.slice(1) || "*"), (t[n] = t[n] || []).unshift(i)) : (t[n] = t[n] || []).push(i);
            };
        }
        function L(t, e, i, n) {
            function r(a) {
                            ...
                            (i = o[e]),
                                ...
                                o !== n &&
                                    (u && n && (J.isPlainObject(n) || (r = J.isArray(n)))
                                        ? (r ? ((r = !1), (s = i && J.isArray(i) ? i : [])) : (s = i && J.isPlainObject(i) ? i : {}), (o[e] = J.extend(u, s, n)))
                                        : void 0 !== n && (o[e] = n));
                return o;
            }),
            J.extend({
                ...
                each: function (t, e, n) {
                    var r = 0,
                        ...
                        o = i(t);
                    if (n) {
                        if (o) for (; r < s && !1 !== e.apply(t[r], n); r++);
                        else for (r in t) if (!1 === e.apply(t[r], n)) break;
                    } else if (o) for (; r < s && !1 !== e.call(t[r], r, t[r]); r++);
                ...
                map: function (t, e, n) {
                    var r,
                        ...
                        a = i(t),
                        l = [];
                    if (a) for (; s < o; s++) null != (r = e(t[s], s, n)) && l.push(r);
                    else for (s in t) null != (r = e(t[s], s, n)) && l.push(r);
                    return W.apply([], l);
                },
                guid: 1,
                proxy: function (t, e) {
                    var i, n, r;
                    if (("string" == typeof e && ((i = t[e]), (e = t), (t = i)), J.isFunction(t)))
                        return (
        ...
        var nt = (function (t) {
                ...
                return (
                    ...
                    n(function (n, o, a, l) {
                        var u,
                            ...
                            y = i ? (s || (n ? t : g || r) ? [] : o) : v;
                        if ((i && i(v, y, a, l), r)) for (u = d(y, m), r(u, [], a, l), h = u.length; h--; ) (c = u[h]) && (y[m[h]] = !(v[m[h]] = c));
                        if (n) {
                            if (s || t) {
                                if (s) {
                ...
                for (
                    ...
                    if ((i = x.relative[t[a].type])) p = [c(f(p), i)];
                        ...
                        if (((i = x.filter[t[a].type].apply(null, t[a].matches)), i[I])) {
                            ...
                            return m(a > 1 && f(p), a > 1 && h(t.slice(0, a - 1).concat({ value: " " === t[a - 2].type ? "*" : "" })).replace(ot, "$1"), i, a < n && g(t.slice(a, n)), n < r && g((t = t.slice(n))), n < r && h(t));
                        }
                        p.push(i);
                    }
                return f(p);
                ...
                var r = i.length > 0,
                    ...
                    o = function (n, o, a, l, u) {
                        ...
                        if (((p += m), r && m !== p)) {
                            ...
                            if (n) {
                                if (p > 0) for (; m--; ) g[m] || _[m] || (_[m] = V.call(l));
                                _ = d(_);
                            }
            ...
            (y = e.support = {}),
                ...
                (A = e.setDocument = function (t) {
                    ...
                    return n !== E && 9 === n.nodeType && n.documentElement
                        ? ((E = n),
                          (R = n.documentElement),
                          (i = n.defaultView),
                          i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", bt, !1) : i.attachEvent && i.attachEvent("onunload", bt)),
                          (D = !w(n)),
                          ...
                          (y.getElementsByClassName = mt.test(n.getElementsByClassName)),
                          ...
                          (M = []),
                          (N = []),
                          (y.qsa = mt.test(n.querySelectorAll)) &&
                              (r(function (t) {
                                  (R.appendChild(t).innerHTML = "<a id='" + I + "'></a><select id='" + I + "-\f]' msallowcapture=''><option selected=''></option></select>"),
                                      t.querySelectorAll("[msallowcapture^='']").length && N.push("[*^$]=" + tt + "*(?:''|\"\")"),
                                      t.querySelectorAll("[selected]").length || N.push("\\[" + tt + "*(?:value|" + K + ")"),
                                      t.querySelectorAll("[id~=" + I + "-]").length || N.push("~="),
                                      t.querySelectorAll(":checked").length || N.push(":checked"),
                                      t.querySelectorAll("a#" + I + "+*").length || N.push(".#.+[+~]");
                              }),
                              r(function (t) {
                          ...
                          (y.matchesSelector = mt.test((j = R.matches || R.webkitMatchesSelector || R.mozMatchesSelector || R.oMatchesSelector || R.msMatchesSelector))) &&
                              r(function (t) {
                                  (y.disconnectedMatch = j.call(t, "div")), j.call(t, "[s!='']:x"), M.push("!=", rt);
                              }),
                          (N = N.length && new RegExp(N.join("|"))),
                          (M = M.length && new RegExp(M.join("|"))),
                          (e = mt.test(R.compareDocumentPosition)),
                          (L =
                          ...
                          (W = e
                              ? function (t, e) {
                                    ...
                                    return (
                                        ...
                                        1 & i || (!y.sortDetached && e.compareDocumentPosition(t) === i)
                                            ? t === n || (t.ownerDocument === F && L(F, t))
                                                ? -1
                                                : e === n || (e.ownerDocument === F && L(F, e))
                                                ? 1
                                                : C
                                                ? J(C, t) - J(C, e)
                                                : 0
                ...
                (e.matchesSelector = function (t, i) {
                    if (((t.ownerDocument || t) !== E && A(t), (i = i.replace(ut, "='$1']")), y.matchesSelector && D && (!M || !M.test(i)) && (!N || !N.test(i))))
                        try {
                            var n = j.call(t, i);
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (t) {
                            ...
                            return ft.CHILD.test(t[0])
                                ? null
                                : (t[3] ? (t[2] = t[4] || t[5] || "") : i && ht.test(i) && (e = T(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && ((t[0] = t[0].slice(0, e)), (t[2] = i.slice(0, e))), t.slice(0, 3));
                        },
                    },
                    filter: {
                        TAG: function (t) {
                            ...
                            return 1 === n && 0 === r
                                ...
                                : function (e, i, l) {
                                      ...
                                      if (g) {
                                          if (s) {
                                              for (; m; ) {
                                                  for (c = e; (c = c[m]); ) if (a ? c.nodeName.toLowerCase() === _ : 1 === c.nodeType) return !1;
                                          ...
                                          else for (; (c = (++p && c && c[m]) || (f = p = 0) || d.pop()) && ((a ? c.nodeName.toLowerCase() !== _ : 1 !== c.nodeType) || !++f || (v && ((c[I] || (c[I] = {}))[t] = [B, f]), c !== e)); );
                        ...
                        PSEUDO: function (t, i) {
                            var r,
                                s = x.pseudos[t] || x.setFilters[t.toLowerCase()] || e.error("unsupported pseudo: " + t);
                            return s[I]
                                ? s(i)
                                : s.length > 1
                                ? ((r = [t, t, "", i]),
            ...
            return (
                ...
                (T = e.tokenize = function (t, i) {
                    ...
                    for (a = t, l = [], u = x.preFilter; a; ) {
                        (n && !(r = at.exec(a))) || (r && (a = a.slice(r[0].length) || a), l.push((s = []))), (n = !1), (r = lt.exec(a)) && ((n = r.shift()), s.push({ value: n, type: r[0].replace(ot, " ") }), (a = a.slice(n.length)));
                        for (o in x.filter) !(r = ft[o].exec(a)) || (u[o] && !(r = u[o](r))) || ((n = r.shift()), s.push({ value: n, type: o, matches: r }), (a = a.slice(n.length)));
                        if (!n) break;
                    }
                ...
                (y.sortStable = I.split("").sort(W).join("") === I),
            ...
            J.fn.extend({
                has: function (t) {
                    ...
                    return this.filter(function () {
                        for (var t = 0; t < i; t++) if (J.contains(this, e[t])) return !0;
                    });
                },
        ...
        (J.Callbacks = function (t) {
                        ...
                        return (
                            l &&
                                J.each(arguments, function (t, e) {
                                    for (var i; (i = J.inArray(e, l, i)) > -1; ) l.splice(i, 1), n && (i <= o && o--, i <= a && a--);
                                }),
                            this
                        );
                    },
            ...
            J.extend({
                ...
                when: function (t) {
                    ...
                    if (o > 1) for (e = new Array(o), i = new Array(o), n = new Array(o); r < o; r++) s[r] && J.isFunction(s[r].promise) ? s[r].promise().done(u(r, n, s)).fail(l.reject).progress(u(r, i, e)) : --a;
        ...
        (J.event = {
                    ...
                    for (
                        ...
                        (a = kt.exec(e[u]) || []),
                            ...
                            p &&
                                ...
                                (c = J.event.special[p] || {}),
                                (h = J.extend({ type: p, origType: m, data: n, handler: i, guid: i.guid, selector: r, needsContext: r && J.expr.match.needsContext.test(r), namespace: d.join(".") }, s)),
                                (f = l[p]) || ((f = l[p] = []), (f.delegateCount = 0), (c.setup && !1 !== c.setup.call(t, n, d, o)) || (t.addEventListener && t.addEventListener(p, o, !1))),
            ...
            remove: function (t, e, i, n, r) {
                var s,
                    ...
                    d,
                    m,
                    g = mt.hasData(t) && mt.get(t);
                if (g && (l = g.events)) {
                    for (e = (e || "").match(ct) || [""], u = e.length; u--; )
                        if (((a = kt.exec(e[u]) || []), (p = m = a[1]), (d = (a[2] || "").split(".").sort()), p)) {
                            for (c = J.event.special[p] || {}, p = (n ? c.delegateType : c.bindType) || p, f = l[p] || [], a = a[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), o = s = f.length; s--; )
                                (h = f[s]),
                                    (!r && m !== h.origType) ||
                                        (i && i.guid !== h.guid) ||
                                        (a && !a.test(h.namespace)) ||
                                        (n && n !== h.selector && ("**" !== n || !h.selector)) ||
                                        (f.splice(s, 1), h.selector && f.delegateCount--, c.remove && c.remove.call(t, h));
                ...
                if (
                    ...
                    for (s = 0; (o = f[s++]) && !e.isPropagationStopped(); )
                        (e.type = s > 1 ? l : c.bindType || p),
                            (h = (mt.get(o, "events") || {})[e.type] && mt.get(o, "handle")),
                            h && h.apply(o, i),
                            (h = u && o[u]) && h.apply && J.acceptData(o) && ((e.result = h.apply(o, i)), !1 === e.result && e.preventDefault());
                    return (
                        (e.type = p),
                        r ||
                            ...
                            !J.acceptData(n) ||
                            (u && J.isFunction(n[p]) && !J.isWindow(n) && ((a = n[u]), a && (n[u] = null), (J.event.triggered = p), n[p](), (J.event.triggered = void 0), a && (n[u] = a))),
                        e.result
                    );
                }
            },
            dispatch: function (t) {
                ...
                if (((a[0] = t), (t.delegateTarget = this), !u.preDispatch || !1 !== u.preDispatch.call(this, t))) {
                    for (o = J.event.handlers.call(this, t, l), e = 0; (r = o[e++]) && !t.isPropagationStopped(); )
                        for (t.currentTarget = r.elem, i = 0; (s = r.handlers[i++]) && !t.isImmediatePropagationStopped(); )
                            (t.namespace_re && !t.namespace_re.test(s.namespace)) ||
                                ((t.handleObj = s), (t.data = s.data), void 0 !== (n = ((J.event.special[s.origType] || {}).handle || s.handler).apply(r.elem, a)) && !1 === (t.result = n) && (t.preventDefault(), t.stopPropagation()));
            ...
            (J.Event = function (t, e) {
                ...
                t && t.type ? ((this.originalEvent = t), (this.type = t.type), (this.isDefaultPrevented = t.defaultPrevented || (void 0 === t.defaultPrevented && !1 === t.returnValue) ? u : h)) : (this.type = t),
                    e && J.extend(this, e),
        ...
        (jt.optgroup = jt.option),
            ...
            J.extend({
                clone: function (t, e, i) {
                    ...
                    if (!(Z.noCloneChecked || (1 !== t.nodeType && 11 !== t.nodeType) || J.isXMLDoc(t))) for (o = _(a), s = _(t), n = 0, r = s.length; n < r; n++) v(s[n], o[n]);
                    if (e)
                        if (i) for (s = s || _(t), o = o || _(a), n = 0, r = s.length; n < r; n++) g(s[n], o[n]);
                        else g(t, a);
                    ...
                    for (var r, s, o, a, l, u, h = e.createDocumentFragment(), c = [], f = 0, p = t.length; f < p; f++)
                        if ((r = t[f]) || 0 === r)
                            if ("object" === J.type(r)) J.merge(c, r.nodeType ? [r] : r);
                                ...
                                for (s = s || h.appendChild(e.createElement("div")), o = (Ot.exec(r) || ["", ""])[1].toLowerCase(), a = jt[o] || jt._default, s.innerHTML = a[1] + r.replace(Ct, "<$1></$2>") + a[2], u = a[0]; u--; )
                                    s = s.lastChild;
                                J.merge(c, s.childNodes), (s = h.firstChild), (s.textContent = "");
                            } else c.push(e.createTextNode(r));
                    for (h.textContent = "", f = 0; (r = c[f++]); )
                        if ((!n || -1 === J.inArray(r, n)) && ((l = J.contains(r.ownerDocument, r)), (s = _(h.appendChild(r), "script")), l && m(s), i)) for (u = 0; (r = s[u++]); ) Dt.test(r.type || "") && i.push(r);
                    return h;
                },
            ...
            J.fn.extend({
                ...
                remove: function (t, e) {
                    for (var i, n = t ? J.filter(t, this) : this, r = 0; null != (i = n[r]); r++)
                        e || 1 !== i.nodeType || J.cleanData(_(i)), i.parentNode && (e && J.contains(i.ownerDocument, i) && m(_(i, "script")), i.parentNode.removeChild(i));
                    return this;
                },
                empty: function () {
                ...
                domManip: function (t, e) {
                    ...
                    var i,
                        ...
                        f = t[0],
                        m = J.isFunction(f);
                    if (m || (u > 1 && "string" == typeof f && !Z.checkClone && Rt.test(f)))
                    ...
                    if (u && ((i = J.buildFragment(t, this[0].ownerDocument, !1, this)), (n = i.firstChild), 1 === i.childNodes.length && (i = n), n)) {
                        ...
                        if (s)
                            for (a = r[r.length - 1].ownerDocument, J.map(r, d), l = 0; l < s; l++)
                                (o = r[l]), Dt.test(o.type || "") && !mt.access(o, "globalEval") && J.contains(a, o) && (o.src ? J._evalUrl && J._evalUrl(o.src) : J.globalEval(o.textContent.replace(Mt, "")));
                    }
                    return this;
                },
            }),
        ...
        J.extend({
            ...
            style: function (t, e, i, n) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    ...
                    (s = typeof i),
                        "string" === s && (r = Xt.exec(i)) && ((i = (r[1] + 1) * r[2] + parseFloat(J.css(t, e))), (s = "number")),
                        null != i &&
                            i === i &&
                            ("number" !== s || J.cssNumber[a] || (i += "px"), Z.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), (o && "set" in o && void 0 === (i = o.set(t, i, n))) || (l[e] = i));
                }
            },
            css: function (t, e, i, n) {
                ...
                return (
                    ...
                    "" === i || i ? ((s = parseFloat(r)), !0 === i || J.isNumeric(s) ? s || 0 : r) : r
                );
            },
        }),
            J.each(["height", "width"], function (t, e) {
                J.cssHooks[e] = {
                    get: function (t, i, n) {
                        if (i)
                            return zt.test(J.css(t, "display")) && 0 === t.offsetWidth
                                ? J.swap(t, Wt, function () {
                                      return k(t, e, n);
                                  })
                                : k(t, e, n);
                    },
            ...
            (J.cssHooks.marginRight = w(Z.reliableMarginRight, function (t, e) {
                if (e) return J.swap(t, { display: "inline-block" }, b, [t, "marginRight"]);
            })),
        ...
        (J.Animation = J.extend(M, {
                ...
                stop: function (t, e, i) {
                    ...
                    return (
                        ...
                        this.each(function () {
                            ...
                            else for (r in o) o[r] && o[r].stop && Qt.test(r) && n(o[r]);
            ...
            J.each({ slideDown: E("show"), slideUp: E("hide"), slideToggle: E("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (t, e) {
            ...
            J.extend({
                attr: function (t, e, i) {
                    ...
                    if (t && 3 !== s && 8 !== s && 2 !== s)
                        return void 0 === t.getAttribute
                            ? J.prop(t, e, i)
                            : ((1 === s && J.isXMLDoc(t)) || ((e = e.toLowerCase()), (n = J.attrHooks[e] || (J.expr.match.bool.test(e) ? te : void 0))),
                              void 0 === i
                ...
                removeAttr: function (t, e) {
                    var i,
                        ...
                        r = 0,
                        s = e && e.match(ct);
                    if (s && 1 === t.nodeType) for (; (i = s[r++]); ) (n = J.propFix[i] || i), J.expr.match.bool.test(i) && (t[n] = !1), t.removeAttribute(i);
                },
                attrHooks: {
                    type: {
                        set: function (t, e) {
        ...
        J.fn.extend({
            ...
            toggleClass: function (t, e) {
                ...
                return "boolean" == typeof e && "string" === i
                    ...
                    : this.each(function () {
                          if ("string" === i) for (var e, n = 0, r = J(this), s = t.match(ct) || []; (e = s[n++]); ) r.hasClass(e) ? r.removeClass(e) : r.addClass(e);
            ...
            hasClass: function (t) {
                for (var e = " " + t + " ", i = 0, n = this.length; i < n; i++) if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(ne, " ").indexOf(e) >= 0) return !0;
                return !1;
            },
        });
        var re = /\r/g;
            ...
            ajax: function (t, e) {
                function i(t, e, i, o) {
                    ...
                    2 !== y &&
                        ...
                        (v = B(c, v, b, l)),
                        l
                            ? (c.ifModified && ((x = b.getResponseHeader("Last-Modified")), x && (J.lastModified[r] = x), (x = b.getResponseHeader("etag")) && (J.etag[r] = x)),
                              204 === t || "HEAD" === c.type ? (w = "nocontent") : 304 === t ? (w = "notmodified") : ((w = v.state), (h = v.data), (_ = v.error), (l = !_)))
                            : ((_ = w), (!t && w) || ((w = "error"), t < 0 && (t = 0))),
                        (b.status = t),
                        (b.statusText = (e || w) + ""),
                        l ? d.resolveWith(f, [h, w, b]) : d.rejectWith(f, [b, w, _]),
                        b.statusCode(g),
                        (g = void 0),
                        u && p.trigger(l ? "ajaxSuccess" : "ajaxError", [b, c, l ? h : _]),
                        m.fireWith(f, [b, w]),
                        u && (p.trigger("ajaxComplete", [b, c]), --J.active || J.event.trigger("ajaxStop")));
                }
                ...
                var n,
                    ...
                    b = {
                        ...
                        getResponseHeader: function (t) {
                            var e;
                            if (2 === y) {
                                if (!o) for (o = {}; (e = ue.exec(s)); ) o[e[1].toLowerCase()] = e[2];
                                e = o[t.toLowerCase()];
                            }
                ...
                if (
                    ...
                    (b.success = b.done),
                    (b.error = b.fail),
                    (c.url = ((t || c.url || _e) + "").replace(ae, "").replace(fe, ve[1] + "//")),
                    (c.type = e.method || e.type || c.method || c.type),
                    (c.dataTypes = J.trim(c.dataType || "*")
                        .toLowerCase()
                        .match(ct) || [""]),
                    null == c.crossDomain &&
                        ((l = pe.exec(c.url.toLowerCase())), (c.crossDomain = !(!l || (l[1] === ve[1] && l[2] === ve[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (ve[3] || ("http:" === ve[1] ? "80" : "443")))))),
                ...
                (u = J.event && c.global),
                    ...
                    (c.hasContent = !ce.test(c.type)),
                    (r = c.url),
                    c.hasContent || (c.data && ((r = c.url += (oe.test(r) ? "&" : "?") + c.data), delete c.data), !1 === c.cache && (c.url = le.test(r) ? r.replace(le, "$1_=" + se++) : r + (oe.test(r) ? "&" : "?") + "_=" + se++)),
                    c.ifModified && (J.lastModified[r] && b.setRequestHeader("If-Modified-Since", J.lastModified[r]), J.etag[r] && b.setRequestHeader("If-None-Match", J.etag[r])),
                    ((c.data && c.hasContent && !1 !== c.contentType) || e.contentType) && b.setRequestHeader("Content-Type", c.contentType),
                    b.setRequestHeader("Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]] ? c.accepts[c.dataTypes[0]] + ("*" !== c.dataTypes[0] ? ", " + ge + "; q=0.01" : "") : c.accepts["*"]);
        ...
        t.attachEvent &&
            ...
            (Z.cors = !!Ce && "withCredentials" in Ce),
            (Z.ajax = Ce = !!Ce),
            J.ajaxTransport(function (t) {
                var e;
                if (Z.cors || (Ce && !t.crossDomain))
                    return {
                        send: function (i, n) {
                            var r,
                                s = t.xhr(),
                                ...
                                return function () {
                                    e &&
                                        ...
                                        "abort" === t
                                            ...
                                            : n(ke[s.status] || s.status, s.statusText, "string" == typeof s.responseText ? { text: s.responseText } : void 0, s.getAllResponseHeaders()));
                                };
                            }),
                                (s.onload = e()),
                                (s.onerror = e("error")),
        ...
        J.ajaxSetup({
            ...
            J.ajaxPrefilter("json jsonp", function (e, i, n) {
                var r,
                    s,
                    o,
                    a = !1 !== e.jsonp && (Ae.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && Ae.test(e.data) && "data");
                if (a || "jsonp" === e.dataTypes[0])
                    return (
                        (r = e.jsonpCallback = J.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback),
                        a ? (e[a] = e[a].replace(Ae, "$1" + r)) : !1 !== e.jsonp && (e.url += (oe.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
        ...
        (J.offset = {
            setOffset: function (t, e, i) {
                ...
                "static" === h && (t.style.position = "relative"),
                    ...
                    u ? ((n = c.position()), (o = n.top), (r = n.left)) : ((o = parseFloat(s) || 0), (r = parseFloat(l) || 0)),
            ...
            J.fn.extend({
                offset: function (t) {
                    ...
                    if (s)
                        return (
                            (e = s.documentElement),
                            J.contains(e, n) ? (void 0 !== n.getBoundingClientRect && (r = n.getBoundingClientRect()), (i = z(s)), { top: r.top + i.pageYOffset - e.clientTop, left: r.left + i.pageXOffset - e.clientLeft }) : r
                        );
                },
                position: function () {
                    if (this[0]) {
    ...
    (function (t, e) {
        ...
        var a = (e.Events = {
                on: function (t, e, i) {
                    return u(this, "on", t, [e, i]) && e ? (this._events || (this._events = {}), (this._events[t] || (this._events[t] = [])).push({ callback: e, context: i, ctx: i || this }), this) : this;
                },
                once: function (t, e, n) {
                ...
                off: function (t, e, n) {
                    ...
                    for (a = t ? [t] : i.keys(this._events), l = 0, h = a.length; l < h; l++)
                        if (((t = a[l]), (o = this._events[t]))) {
                            if (((this._events[t] = r = []), e || n)) for (c = 0, f = o.length; c < f; c++) (s = o[c]), ((e && e !== s.callback && e !== s.callback._callback) || (n && n !== s.context)) && r.push(s);
        ...
        i.extend(f.prototype, a, {
            ...
            save: function (t, e, n) {
                var r,
                    ...
                    o,
                    a = this.attributes;
                if ((null == t || "object" == typeof t ? ((r = t), (n = e)) : ((r = {})[t] = e), (n = i.extend({ validate: !0 }, n)), r && !n.wait)) {
                ...
                return (
                    ...
                    "patch" === s && (n.attrs = r),
                    (o = this.sync(s, this, n)),
                    r && n.wait && (this.attributes = a),
                    o
                );
            },
            destroy: function (t) {
        ...
        i.extend(d.prototype, a, {
            ...
            add: function (t, e) {
                return this.set(t, i.extend({ merge: !1 }, e, g));
            },
            remove: function (t, e) {
                var n = !i.isArray(t);
                (t = n ? [t] : i.clone(t)), e || (e = {});
                ...
                for (r = 0, s = t.length; r < s; r++)
                    (a = t[r] = this.get(t[r])) && ((o = this.indexOf(a)), this.models.splice(o, 1), this.length--, e.silent || ((e.index = o), a.trigger("remove", a, this, e)), this._removeReference(a, e));
                return n ? t[0] : t;
            },
            set: function (t, e) {
                ...
                var r,
                    ...
                    T = !(d || !x || !w) && [];
                for (r = 0, s = t.length; r < s; r++) {
                    if (((l = t[r] || {}), (o = l instanceof f ? (a = l) : l[p.prototype.idAttribute || "id"]), (u = this.get(o))))
                        w && (y[u.cid] = !0), b && ((l = l === a ? a.attributes : l), e.parse && (l = u.parse(l, e)), u.set(l, e), d && !h && u.hasChanged(g) && (h = !0)), (t[r] = u);
                    else if (x) {
                ...
                if (_.length || (T && T.length))
                    if ((d && (h = !0), (this.length += _.length), null != c)) for (r = 0, s = _.length; r < s; r++) this.models.splice(c + r, 0, _[r]);
                    else {
            ...
            _onModelEvent: function (t, e, i, n) {
                (("add" !== t && "remove" !== t) || i === this) &&
                    ("destroy" === t && this.remove(e, n), e && t === "change:" + e.idAttribute && (delete this._byId[e.previous(e.idAttribute)], null != e.id && (this._byId[e.id] = e)), this.trigger.apply(this, arguments));
            },
        });
        var _ = [
            "forEach",
            ...
            i.extend(A.prototype, a, {
                ...
                start: function (t) {
                    ...
                    (this.root = ("/" + this.root + "/").replace(R, "/")),
                        s && this._wantsHashChange && ((this.iframe = e.$('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow), this.navigate(n)),
                        this._hasPushState
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
        ...
        function (t, e, i) {
            ...
            (r.version = "1.17.0"),
                ...
                (u.render = function (t, e, i) {
                        ...
                        (t >= p
                            ? ((this._totalTime = p),
                              ...
                              0 === _ &&
                                  ...
                                  (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > v || v === s) && v !== t && ((i = !0), v > s && (r = "onReverseComplete")), (this._rawPrevTime = f = !e || t || v === t ? t : s)))
                            : 1e-7 > t
                            ? ((this._totalTime = this._time = this._cycle = 0),
                              (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
                              (0 !== m || (0 === _ && v > 0)) && ((r = "onReverseComplete"), (n = this._reversed)),
                              0 > t && ((this._active = !1), 0 === _ && (this._initted || !this.vars.lazy || i) && (v >= 0 && (i = !0), (this._rawPrevTime = f = !e || t || v === t ? t : s))),
                              this._initted || (i = !0))
                            : ((this._totalTime = this._time = t),
                              ...
                              this._easeType
                                  ? ((u = this._time / _),
                                    ...
                                    (this.ratio = 1 === h ? 1 - u : 2 === h ? u : 0.5 > this._time / _ ? u / 2 : 1 - u / 2))
                    ...
                    if (!this._initted) {
                        ...
                        if (!i && this._firstPT && ((!1 !== this.vars.lazy && this._duration) || (this.vars.lazy && !this._duration)))
                            return (this._time = d), (this._totalTime = m), (this._rawPrevTime = v), (this._cycle = g), o.lazyTweens.push(this), void (this._lazy = [t, e]);
                    ...
                    this._onUpdate && (0 > t && this._startAt && this._startTime && this._startAt.render(t, e, i), e || ((this._totalTime !== m || n) && this._callback("onUpdate"))),
                        ...
                        r &&
                            ...
                            0 === _ && this._rawPrevTime === s && f !== s && (this._rawPrevTime = 0));
                }),
                (r.to = function (t, e, i) {
                    return new r(t, e, i);
                }),
                ...
                (r.delayedCall = function (t, e, i, n, s) {
                    return new r(e, 0, { delay: t, onComplete: e, onCompleteParams: i, callbackScope: n, onReverseComplete: e, onReverseCompleteParams: i, immediateRender: !1, useFrames: s, overwrite: 0 });
                }),
                (r.set = function (t, e) {
                    return new r(t, 0, e);
                }),
            ...
            function (t, e, i) {
                ...
                return (
                    ...
                    (g.staggerTo = function (t, e, r, s, o, l, u, h) {
                        var c,
                            f = new n({ onComplete: l, onCompleteParams: u, callbackScope: h, smoothChildTiming: this.smoothChildTiming });
                    ...
                    (g.add = function (r, s, o, a) {
                        ...
                        if (("number" != typeof s && (s = this._parseTimeOrLabel(s, 0, !0, r)), !(r instanceof t))) {
                            if (r instanceof Array || (r && r.push && l(r))) {
                                for (o = o || "normal", a = a || 0, u = s, h = r.length, c = 0; h > c; c++)
                    ...
                    (g.render = function (t, e, i) {
                        ...
                        if (t >= c)
                            ...
                            if (
                                ...
                                (0 !== f || (0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || (0 > t && this._rawPrevTime >= 0)))) && ((a = "onReverseComplete"), (s = this._reversed)),
                                0 > t)
                            )
                        ...
                        if ((this._time !== f && this._first) || i || l) {
                            if (
                                ...
                                for (n = this._first; n && ((o = n._next), !this._paused || m); )
                                    (n._active || (n._startTime <= this._time && !n._paused && !n._gc)) &&
                                        (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)),
                                        (n = o);
                            else
                                for (n = this._last; n && ((o = n._prev), !this._paused || m); )
                                    (n._active || (f >= n._startTime && !n._paused && !n._gc)) &&
                                        (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)),
                                        (n = o);
                                ...
                                a &&
                                    (this._gc ||
                                        ((p === this._startTime || d !== this._timeScale) &&
                                            ...
                                            (s && (u.length && h(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), !e && this.vars[a] && this._callback(a))));
                        }
                    }),
                    ...
                    (g.getChildren = function (t, e, n, r) {
                        ...
                        for (var s = [], o = this._first, a = 0; o; )
                            r > o._startTime || (o instanceof i ? !1 !== e && (s[a++] = o) : (!1 !== n && (s[a++] = o), !1 !== t && ((s = s.concat(o.getChildren(!0, e, n))), (a = s.length)))), (o = o._next);
                        return s;
                    }),
                ...
                return (
                    ...
                    (u.render = function (t, e, i) {
                        ...
                        if (t >= f)
                            this._locked || ((this._totalTime = f), (this._cycle = this._repeat)),
                                this._reversed ||
                                    ...
                                    0 === this._duration && (0 === t || 0 > v || v === r) && v !== t && this._first && ((h = !0), v > r && (u = "onReverseComplete"))),
                                (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r),
                            ...
                            if (
                                ...
                                (this._time = 0),
                                (0 !== d || (0 === p && v !== r && (v > 0 || (0 > t && v >= 0)) && !this._locked)) && ((u = "onReverseComplete"), (s = this._reversed)),
                                0 > t)
                            )
                                (this._active = !1), this._timeline.autoRemoveChildren && this._reversed ? ((h = s = !0), (u = "onReverseComplete")) : v >= 0 && this._first && (h = !0), (this._rawPrevTime = t);
                            else {
                                if (((this._rawPrevTime = p || !e || t || this._rawPrevTime === t ? t : r), 0 === t && s)) for (n = this._first; n && 0 === n._startTime; ) n._duration || (s = !1), (n = n._next);
                        ...
                        if (
                            ...
                            for (n = this._first; n && ((l = n._next), !this._paused || y); )
                                (n._active || (n._startTime <= this._time && !n._paused && !n._gc)) &&
                                    (n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (t - n._startTime) * n._timeScale, e, i) : n.render((t - n._startTime) * n._timeScale, e, i)),
                                    (n = l);
                        else
                            for (n = this._last; n && ((l = n._prev), !this._paused || y); )
                        ...
                        this._onUpdate && (e || (o.length && a(), this._callback("onUpdate"))),
                            u &&
                                (this._locked ||
                                    this._gc ||
                                    ((g === this._startTime || _ !== this._timeScale) &&
                                        (0 === this._time || f >= this.totalDuration()) &&
                                        (s && (o.length && a(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), !e && this.vars[u] && this._callback(u))));
                    }),
                    ...
                    for (u = 0; w > u; u++)
                        (p = t[T]),
                            ...
                            l
                                ? ((y = e[u]),
                                  (x = i[u]),
                                  (b = (0.25 * (x + y) * r) / (o ? 0.5 : n[u] || 0.5)),
                                  (d = c - (c - h) * (o ? 0.5 * r : 0 !== y ? b / y : 0)),
                                  (m = c + (f - c) * (o ? 0.5 * r : 0 !== x ? b / x : 0)),
                                  (g = c - (d + (((m - d) * ((3 * y) / (y + x) + 0.5)) / 4 || 0))))
                                : ((d = c - 0.5 * (c - h) * r), (m = c + 0.5 * (f - c) * r), (g = c - (d + m) / 2)),
                            (d += g),
                            (m += g),
                            (p.c = _ = d),
                            ...
                            (p.ca = _ - h),
                            (p.ba = S - h),
                            s ? ((v = a(h, S, _, c)), t.splice(T, 1, v[0], v[1], v[2], v[3]), (T += 4)) : T++,
                            (S = m);
                    (p = t[T]), (p.b = S), (p.c = S + 0.4 * (p.d - S)), (p.da = p.d - p.a), (p.ca = p.c - p.a), (p.ba = S - p.a), s && ((v = a(p.a, S, p.c, p.d)), t.splice(T, 1, v[0], v[1], v[2], v[3]));
                },
                u = function (t, n, r, s) {
                    var a,
                        l,
                ...
                h = function (t, s, o, a, h, c) {
                    ...
                    if (t.length > 1) {
                        for (y = t[t.length - 1], v = !0, f = b.length; --f > -1; )
                            if (((p = b[f]), Math.abs(w[p] - y[p]) > 0.05)) {
                                v = !1;
                                break;
                            }
                    ...
                    if (!a) {
                        for (f = b.length; --f > -1; ) if (r[p]) for (d = x[b[f]], _ = d.length - 1, m = 0; _ > m; m++) (g = d[m + 1].da / i[m] + d[m].da / e[m]), (n[m] = (n[m] || 0) + g * g);
                ...
                c = function (t, e, i) {
                    ...
                    for (u = v.length; --u > -1; ) {
                        for (f = v[u], m[f] = l = [], p = 0, c = t.length, h = 0; c > h; h++)
                            (n = null == i ? t[h][f] : "string" == typeof (d = t[h][f]) && "=" === d.charAt(1) ? i[f] + Number(d.charAt(0) + d.substr(2)) : Number(d)), _ && h > 1 && c - 1 > h && (l[p++] = (n + l[p - 2]) / 2), (l[p++] = n);
                    ...
                    init: function (t, e, i) {
                        ...
                        for (s = this._props.length; --s > -1; )
                            (n = this._props[s]),
                                ...
                                a || (u[n] !== l[0][n] && (a = u));
                        if (
                            ((this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? h(l, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, a) : c(l, e.type, u)),
                            ...
                            parser: function (t, e, s, o, a, l) {
                                ...
                                return (
                                    ...
                                    !g.autoRotate ||
                                        ...
                                        ((u = !0 === g.autoRotate ? 0 : Number(g.autoRotate)), (g.autoRotate = null != c.end.left ? [["left", "top", "rotation", u, !1]] : null != c.end.x && [["x", "y", "rotation", u, !1]])),
                                    g.autoRotate && (o._transform || o._enableTransforms(!1), (c.autoRotate = o._target._gsTransform)),
            ...
            function (t, e) {
                ...
                var h,
                    ...
                    q = (function () {
                        var t = z.indexOf("Android"),
                            e = I("a");
                        return (
                            (f = -1 !== z.indexOf("Safari") && -1 === z.indexOf("Chrome") && (-1 === t || Number(z.substr(t + 8, 1)) > 3)),
                            (d = f && 6 > Number(z.substr(z.indexOf("Version/") + 8, 1))),
                            (p = -1 !== z.indexOf("Firefox")),
                            (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(z) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(z)) && (m = parseFloat(RegExp.$1)),
                    ...
                    G = (o.getStyle = function (t, e, i, n, r) {
                        var s;
                        return q || "opacity" !== e
                            ? (!n && t.style[e] ? (s = t.style[e]) : (i = i || V(t)) ? (s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(P, "-$1").toLowerCase())) : t.currentStyle && (s = t.currentStyle[e]),
                    ...
                    Z = (H.convertToPixels = function (t, i, n, r, s) {
                        ...
                        if ((p && (n = -n), "%" === r && -1 !== i.indexOf("border"))) a = (n / 100) * (h ? t.clientWidth : t.clientHeight);
                            ...
                            c.appendChild(F),
                                ...
                                c.removeChild(F),
                                h && "%" === r && !1 !== o.cacheWidths && ((l = c._gsCache = c._gsCache || {}), (l.time = u), (l.width = (a / n) * 100)),
                                0 !== a || s || (a = Z(t, i, n, r, !0));
                        }
                        return p ? -a : a;
                    }),
                    ...
                    J = function (t, e) {
                        var i,
                            ...
                            s = {};
                        if ((e = e || V(t, null)))
                            if ((i = e.length)) for (; --i > -1; ) (r = e[i]), (-1 === r.indexOf("-transform") || Tt === r) && (s[r.replace(k, O)] = e.getPropertyValue(r));
                            else for (i in e) (-1 === i.indexOf("Transform") || wt === i) && (s[i] = e[i]);
                        else if ((e = t.currentStyle || t.style)) for (i in e) "string" == typeof i && void 0 === s[i] && (s[i.replace(k, O)] = e[i]);
                        return (
                            q || (s.opacity = X(t)),
                            (n = jt(t, e, !1)),
                            ...
                            (s.x = n.x),
                            (s.y = n.y),
                            Pt && ((s.z = n.z), (s.rotationX = n.rotationX), (s.rotationY = n.rotationY), (s.scaleZ = n.scaleZ)),
                        ...
                        return (
                            null == t
                                ...
                                : ((r = 360),
                                  (s = t.split("_")),
                                  (l = "=" === t.charAt(1)),
                                  (o = (l ? parseInt(t.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (-1 === t.indexOf("rad") ? 1 : M) - (l ? 0 : e)),
                                  s.length &&
                                      (n && (n[i] = e + o),
                ...
                var ct = function (t, e, i, n) {
                        ...
                        return h
                            ? (r = e
                                  ? function (t) {
                                        ...
                                        if (((e = (t.match(ht) || [s])[0]), (f = t.split(e).join("").match(v) || []), (p = f.length), h > p--)) for (; h > ++p; ) f[p] = i ? f[0 | ((p - 1) / 2)] : o[p];
                                  ...
                                  : function (t) {
                                        ...
                                        if (((e = t.match(v) || []), (f = e.length), h > f--)) for (; h > ++f; ) e[f] = i ? e[0 | ((f - 1) / 2)] : o[f];
                                        return a + e.join(u) + l;
                                    })
                            : function (t) {
                                  return t;
                    ...
                    gt = (o.parseComplex = function (t, e, i, n, r, s, o, a, l, u) {
                        ...
                        var c,
                            ...
                            A = !1 !== h;
                        for (
                            (-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && ((k = k.join(" ").replace(D, ", ").split(" ")), (C = C.join(" ").replace(D, ", ").split(" ")), (O = k.length)),
                                O !== C.length && ((k = (s || "").split(" ")), (O = k.length)),
                                o.plugin = l,
                                o.setRatio = u,
                                c = 0;
                            O > c;
                            ...
                            if (((d = k[c]), (m = C[c]), (x = parseFloat(d)) || 0 === x)) o.appendXtra("", x, rt(m, x), m.replace(_, ""), A && -1 !== m.indexOf("px"), !0);
                            else if (r && ("#" === d.charAt(0) || at[d] || S.test(d)))
                                (P = "," === m.charAt(m.length - 1) ? ")," : ")"),
                                    ...
                                    b && !q && 0 === m[3]
                                        ...
                                        : (q || (b = !1),
                                          o
                                              .appendXtra(b ? "rgba(" : "rgb(", d[0], m[0] - d[0], ",", !0, !0)
                                              .appendXtra("", d[1], m[1] - d[1], ",", !0)
                                              .appendXtra("", d[2], m[2] - d[2], b ? "," : P, !0),
                                          b && ((d = 4 > d.length ? 1 : d[3]), o.appendXtra("", d, (4 > m.length ? 1 : m[3]) - d, P, !1)));
                            else if ((v = d.match(g))) {
                ...
                var xt,
                    ...
                    Et = (function () {
                        var t,
                            e,
                            i,
                            n = m || (/Android/i.test(z) && !window.chrome);
                        return (
                            L.createElementNS &&
                                !n &&
                                ((t = Ot("svg", At)),
                    ...
                    Rt = function (t, e, i, n, r) {
                        ...
                        x && ((v = x.xOrigin), (y = x.yOrigin)),
                            ...
                            n &&
                                ...
                                (g = b[5]),
                                (_ = c * d - f * p),
                                (a = u * (d / _) + h * (-p / _) + (p * g - d * m) / _),
                                (l = u * (-f / _) + h * (c / _) - (c * g - f * m) / _),
                                (u = i.xOrigin = s[0] = a),
                                (h = i.yOrigin = s[1] = l)),
                            x && (r || (!1 !== r && !1 !== o.defaultSmoothOrigin) ? ((a = u - v), (l = h - y), (x.xOffset += a * b[0] + l * b[2] - a), (x.yOffset += a * b[1] + l * b[3] - l)) : (x.xOffset = x.yOffset = 0)),
                    ...
                    Mt = function (t, e) {
                        ...
                        if (
                            ...
                            (a.svg || (t.getBBox && Dt(t))) &&
                                (i && -1 !== (t.style[wt] + "").indexOf("matrix") && ((n = t.style[wt]), (i = 0)),
                                (r = t.getAttribute("transform")),
                                i && r && (-1 !== r.indexOf("matrix") ? ((n = r), (i = 0)) : -1 !== r.indexOf("translate") && ((n = "matrix(1,0,0,1," + r.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")"), (i = 0)))),
                            i)
                        )
                            return Nt;
                        for (r = (n || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], _t = r.length; --_t > -1; ) (s = Number(r[_t])), (r[_t] = (o = s - (s |= 0)) ? (0 | (1e5 * o + (0 > o ? -0.5 : 0.5))) / 1e5 + s : s);
                    ...
                    jt = (H.getTransform = function (t, i, n, s) {
                        ...
                        var a,
                            ...
                            c,
                            f,
                            p = n ? t._gsTransform || new kt() : new kt(),
                            d = 0 > p.scaleX,
                            m = 1e5,
                        ...
                        if (((p.svg = !(!t.getBBox || !Dt(t))), p.svg && (Rt(t, G(t, St, r, !1, "50% 50%") + "", p, t.getAttribute("data-svg-origin")), (xt = o.useSVGTransformAttr || Et)), (a = Mt(t)) !== Nt)) {
                            if (16 === a.length) {
                                var v,
                                    ...
                                    F = a[11],
                                    B = Math.atan2(A, N);
                                p.zOrigin && ((I = -p.zOrigin), (j = R * I - a[12]), (L = D * I - a[13]), (I = N * I + p.zOrigin - a[14])),
                                    (p.rotationX = B * M),
                                    B &&
                                        ((b = Math.cos(-B)),
                                        (w = Math.sin(-B)),
                                    ...
                                    (B = Math.atan2(R, N)),
                                    (p.rotationY = B * M),
                                    B && ((b = Math.cos(-B)), (w = Math.sin(-B)), (v = T * b - R * w), (y = S * b - D * w), (x = P * b - N * w), (D = S * w + D * b), (N = P * w + N * b), (F = k * w + F * b), (T = v), (S = y), (P = x)),
                                    (B = Math.atan2(S, T)),
                                    (p.rotation = B * M),
                                    B && ((b = Math.cos(-B)), (w = Math.sin(-B)), (T = T * b + C * w), (y = S * b + O * w), (O = S * -w + O * b), (A = P * -w + A * b), (S = y)),
                                    p.rotationX && Math.abs(p.rotationX) + Math.abs(p.rotation) > 359.9 && ((p.rotationX = p.rotation = 0), (p.rotationY += 180)),
                                    (p.scaleX = (0 | (Math.sqrt(T * T + S * S) * m + 0.5)) / m),
                                    (p.scaleY = (0 | (Math.sqrt(O * O + D * D) * m + 0.5)) / m),
                                    (p.scaleZ = (0 | (Math.sqrt(A * A + N * N) * m + 0.5)) / m),
                                    (p.skewX = 0),
                                    (p.perspective = F ? 1 / (0 > F ? -F : F) : 0),
                                    (p.x = j),
                                    (p.y = L),
                                    (p.z = I),
                                    p.svg && ((p.x -= p.xOrigin - (p.xOrigin * T - p.yOrigin * C)), (p.y -= p.yOrigin - (p.yOrigin * S - p.xOrigin * O)));
                                ...
                                (p.x = a[4] || 0),
                                    ...
                                    (u = Math.sqrt(z * z + q * q)),
                                    (h = Math.sqrt(W * W + X * X)),
                                    (c = z || q ? Math.atan2(q, z) * M : p.rotation || 0),
                                    (f = X || W ? Math.atan2(X, W) * M + c : p.skewX || 0),
                                    Math.abs(f) > 90 && 270 > Math.abs(f) && (d ? ((u *= -1), (f += 0 >= c ? 180 : -180), (c += 0 >= c ? 180 : -180)) : ((h *= -1), (f += 0 >= f ? 180 : -180))),
                                    (p.scaleX = u),
                                    (p.scaleY = h),
                                    (p.rotation = c),
                                    (p.skewX = f),
                                    Pt && ((p.rotationX = p.rotationY = p.z = 0), (p.perspective = _), (p.scaleZ = 1)),
                                    p.svg && ((p.x -= p.xOrigin - (p.xOrigin * z + p.yOrigin * X)), (p.y -= p.yOrigin - (p.xOrigin * q + p.yOrigin * W)));
                            }
                            p.zOrigin = g;
                    ...
                    Lt = function (t) {
                        ...
                        if (f) {
                            ...
                            if (
                                (null != n.ox && ((p = (n.oxp ? 0.01 * g * n.ox : n.ox) - g / 2), (d = (n.oyp ? 0.01 * _ * n.oy : n.oy) - _ / 2), (w += p - (p * a + d * l)), (T += d - (p * u + d * h))),
                                v ? ((p = g / 2), (d = _ / 2), (y += ", Dx=" + (p - (p * a + d * l) + w) + ", Dy=" + (d - (p * u + d * h) + T) + ")")) : (y += ", sizingMethod='auto expand')"),
                                (c.filter = -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? e.replace(R, y) : y + " " + e),
                                (0 === t || 1 === t) &&
                                    1 === a &&
                                    0 === l &&
                                    0 === u &&
                                    1 === h &&
                                    ((v && -1 === y.indexOf("Dx=0, Dy=0")) || (b.test(e) && 100 !== parseFloat(RegExp.$1)) || (-1 === e.indexOf(e.indexOf("Alpha")) && c.removeAttribute("filter"))),
                                !v)
                            ) {
                                var S,
                                    P,
                                ...
                                for (
                                    p = n.ieOffsetX || 0,
                                        ...
                                        n.ieOffsetY = Math.round((_ - ((0 > h ? -h : h) * _ + (0 > u ? -u : u) * g)) / 2 + T),
                                        _t = 0;
                                    4 > _t;
                                    _t++
                                )
                                    (P = et[_t]),
                                        (S = f[P]),
                                        (i = -1 !== S.indexOf("px") ? parseFloat(S) : Z(this.t, P, parseFloat(S), S.replace(x, "")) || 0),
                                        (k = i !== n[P] ? (2 > _t ? -n.ieOffsetX : -n.ieOffsetY) : 2 > _t ? p - n.ieOffsetX : d - n.ieOffsetY),
                                        (c[P] = (n[P] = Math.round(i - k * (0 === _t || 2 === _t ? 1 : C))) + "px");
                            }
                        }
                    },
                    It = (H.set3DTransformRatio = H.setTransformRatio = function (t) {
                        var e,
                            ...
                            F = P.perspective,
                            B = P.force3D;
                        if (!((((1 !== t && 0 !== t) || "auto" !== B || (this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime)) && B) || L || F || A || O) || (xt && I) || !Pt)
                            return void (C || P.skewX || I
                                ? ((C *= N),
                                  (T = P.skewX * N),
                                  (S = 1e5),
                                  (e = Math.cos(C) * E),
                                  ...
                                  (i = Math.sin(C - T) * -R),
                                  (s = Math.cos(C - T) * R),
                                  T && "simple" === P.skewType && ((v = Math.tan(T)), (v = Math.sqrt(1 + v * v)), (i *= v), (s *= v), P.skewY && ((e *= v), (r *= v))),
                                  I &&
                                      ((M += P.xOrigin - (P.xOrigin * e + P.yOrigin * i) + P.xOffset),
                                      (j += P.yOrigin - (P.xOrigin * r + P.yOrigin * s) + P.yOffset),
                                      xt && (P.xPercent || P.yPercent) && ((m = this.t.getBBox()), (M += 0.01 * P.xPercent * m.width), (j += 0.01 * P.yPercent * m.height)),
                                      (m = 1e-6),
                                      m > M && M > -m && (M = 0),
                                      m > j && j > -m && (j = 0)),
                                  (x = (0 | (e * S)) / S + "," + (0 | (r * S)) / S + "," + (0 | (i * S)) / S + "," + (0 | (s * S)) / S + "," + M + "," + j + ")"),
                                  I && xt ? this.t.setAttribute("transform", "matrix(" + x) : (k[wt] = (P.xPercent || P.yPercent ? "translate(" + P.xPercent + "%," + P.yPercent + "%) matrix(" : "matrix(") + x))
                                : (k[wt] = (P.xPercent || P.yPercent ? "translate(" + P.xPercent + "%," + P.yPercent + "%) matrix(" : "matrix(") + E + ",0,0," + R + "," + M + "," + j + ")"));
                        if ((p && ((m = 1e-4), m > E && E > -m && (E = D = 2e-5), m > R && R > -m && (R = D = 2e-5), !F || P.z || P.rotationX || P.rotationY || (F = 0)), C || P.skewX))
                            (C *= N),
                                (g = e = Math.cos(C)),
                                (_ = r = Math.sin(C)),
                                P.skewX &&
                                    ((C -= P.skewX * N), (g = Math.cos(C)), (_ = Math.sin(C)), "simple" === P.skewType && ((v = Math.tan(P.skewX * N)), (v = Math.sqrt(1 + v * v)), (g *= v), (_ *= v), P.skewY && ((e *= v), (r *= v)))),
                                (i = -_),
                                (s = g);
                        else {
                            if (!(A || O || 1 !== D || F || I))
                        ...
                        (u = 1),
                            ...
                            (w = "0"),
                            (C = A * N),
                            C && ((g = Math.cos(C)), (_ = Math.sin(C)), (a = -_), (h = f * -_), (n = e * _), (o = r * _), (u = g), (f *= g), (e *= g), (r *= g)),
                            (C = O * N),
                            C && ((g = Math.cos(C)), (_ = Math.sin(C)), (v = i * g + n * _), (y = s * g + o * _), (l = u * _), (c = f * _), (n = i * -_ + n * g), (o = s * -_ + o * g), (u *= g), (f *= g), (i = v), (s = y)),
                            1 !== D && ((n *= D), (o *= D), (u *= D), (f *= D)),
                            1 !== R && ((i *= R), (s *= R), (l *= R), (c *= R)),
                            1 !== E && ((e *= E), (r *= E), (a *= E), (h *= E)),
                            (d || I) &&
                                (d && ((M += n * -d), (j += o * -d), (L += u * -d + d)),
                                I && ((M += P.xOrigin - (P.xOrigin * e + P.yOrigin * i) + P.xOffset), (j += P.yOrigin - (P.xOrigin * r + P.yOrigin * s) + P.yOffset)),
                                m > M && M > -m && (M = w),
                                m > j && j > -m && (j = w),
                                m > L && L > -m && (L = 0)),
                            (x = P.xPercent || P.yPercent ? "translate(" + P.xPercent + "%," + P.yPercent + "%) matrix3d(" : "matrix3d("),
                            (x += (m > e && e > -m ? w : e) + b + (m > r && r > -m ? w : r) + b + (m > a && a > -m ? w : a)),
                            (x += b + (m > h && h > -m ? w : h) + b + (m > i && i > -m ? w : i) + b + (m > s && s > -m ? w : s)),
                            O || A
                                ? ((x += b + (m > l && l > -m ? w : l) + b + (m > c && c > -m ? w : c) + b + (m > n && n > -m ? w : n)),
                                  (x += b + (m > o && o > -m ? w : o) + b + (m > u && u > -m ? w : u) + b + (m > f && f > -m ? w : f) + b))
                                : (x += ",0,0,0,0,1,0,"),
                            (x += M + b + j + b + L + b + (F ? 1 + -L / F : 1) + ")"),
                            (k[wt] = x);
                    });
                (u = kt.prototype),
                        ...
                        "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
                        {
                            parser: function (t, e, i, n, s, a, l) {
                                ...
                                var u,
                                    ...
                                    T = {},
                                    S = "transformOrigin";
                                if ("string" == typeof w.transform && wt)
                                    (c = F.style),
                                        (c[wt] = w.transform),
                                        (c.display = "block"),
                                        (c.position = "absolute"),
                                        ...
                                        null != w.xPercent && (u.xPercent = st(w.xPercent, y.xPercent)),
                                        null != w.yPercent && (u.yPercent = st(w.yPercent, y.yPercent));
                                    ...
                                    "string" == typeof w.x && -1 !== w.x.indexOf("%") && ((u.x = 0), (u.xPercent = st(w.x, y.xPercent))),
                                        "string" == typeof w.y && -1 !== w.y.indexOf("%") && ((u.y = 0), (u.yPercent = st(w.y, y.yPercent))),
                                        (u.rotation = ot("rotation" in w ? w.rotation : "shortRotation" in w ? w.shortRotation + "_short" : "rotationZ" in w ? w.rotationZ : y.rotation, y.rotation, "rotation", T)),
                                        Pt &&
                                            ((u.rotationX = ot("rotationX" in w ? w.rotationX : "shortRotationX" in w ? w.shortRotationX + "_short" : y.rotationX || 0, y.rotationX, "rotationX", T)),
                                            (u.rotationY = ot("rotationY" in w ? w.rotationY : "shortRotationY" in w ? w.shortRotationY + "_short" : y.rotationY || 0, y.rotationY, "rotationY", T))),
                                        (u.skewX = null == w.skewX ? y.skewX : ot(w.skewX, y.skewX)),
                                        (u.skewY = null == w.skewY ? y.skewY : ot(w.skewY, y.skewY)),
                                        (h = u.skewY - y.skewY) && ((u.skewX += h), (u.rotation += h));
                                }
                                for (
                                    Pt && null != w.force3D && ((y.force3D = w.force3D), (d = !0)),
                                        y.skewType = w.skewType || y.skewType || o.defaultSkewType,
                                        (p = y.force3D || y.z || y.rotationX || y.rotationY || u.z || u.rotationX || u.rotationY || u.perspective) || null == w.scale || (u.scaleZ = 1);
                                    --b > -1;

                                )
                                    (i = bt[b]),
                                        ((f = u[i] - y[i]) > 1e-6 || -1e-6 > f || null != w[i] || null != j[i]) && ((d = !0), (s = new dt(y, i, y[i], f, s)), i in T && (s.e = T[i]), (s.xs0 = 0), (s.plugin = a), n._overwriteProps.push(s.n));
                                return (
                                    (f = w.transformOrigin),
                                    y.svg &&
                                        (f || w.svgOrigin) &&
                                        ((g = y.xOffset),
                                        (_ = y.yOffset),
                                        Rt(t, nt(f), u, w.svgOrigin, w.smoothOrigin),
                                        (s = mt(y, "xOrigin", (v ? y : u).xOrigin, u.xOrigin, s, S)),
                                        (s = mt(y, "yOrigin", (v ? y : u).yOrigin, u.yOrigin, s, S)),
                                        (g !== y.xOffset || _ !== y.yOffset) && ((s = mt(y, "xOffset", v ? g : y.xOffset, y.xOffset, s, S)), (s = mt(y, "yOffset", v ? _ : y.yOffset, y.yOffset, s, S))),
                                        (f = xt ? null : "0px 0px")),
                                    (f || (Pt && p && y.zOrigin)) &&
                                        (wt
                                            ? ((d = !0),
                                              (i = St),
                                              (f = (f || G(t, i, r, !1, "50% 50%")) + ""),
                                              (s = new dt(x, i, 0, 0, s, -1, S)),
                                              (s.b = x[i]),
                                              (s.plugin = a),
                                              Pt
                                                  ? ((c = y.zOrigin),
                                                    (f = f.split(" ")),
                                                    (y.zOrigin = (f.length > 2 && (0 === c || "0px" !== f[2]) ? parseFloat(f[2]) : c) || 0),
                                                    (s.xs0 = s.e = f[0] + " " + (f[1] || "50%") + " 0px"),
                                                    (s = new dt(y, "zOrigin", 0, 0, s, -1, s.n)),
                                                    (s.b = c),
                                                    (s.xs0 = s.e = y.zOrigin))
                                                  : (s.xs0 = s.e = f))
                                            : nt(f + "", y)),
                                    d && (n._transformType = (y.svg && xt) || (!p && 3 !== this._transformType) ? 2 : 3),
                                    s
                                );
                            },
                            prefix: !0,
                        ...
                        parser: function (t, e, i, s, o) {
                            ...
                            for (m = parseFloat(t.offsetWidth), g = parseFloat(t.offsetHeight), a = e.split(" "), l = 0; T.length > l; l++)
                                this.p.indexOf("border") && (T[l] = Y(T[l])),
                                    (c = h = G(t, T[l], r, !1, "0px")),
                                    -1 !== c.indexOf(" ") && ((h = c.split(" ")), (c = h[0]), (h = h[1])),
                                    (f = u = a[l]),
                                    (p = parseFloat(c)),
                                    (v = c.substr((p + "").length)),
                                    (y = "=" === f.charAt(1)),
                                    ...
                                    _ !== v &&
                                        ...
                                        (b = Z(t, "borderTop", p, v)),
                                        "%" === _ ? ((c = (x / m) * 100 + "%"), (h = (b / g) * 100 + "%")) : "em" === _ ? ((w = Z(t, "borderLeft", 1, "em")), (c = x / w + "em"), (h = b / w + "em")) : ((c = x + "px"), (h = b + "px")),
                                        y && ((f = parseFloat(c) + d + _), (u = parseFloat(h) + d + _))),
                                    (o = gt(S, T[l], c + " " + h, f + " " + u, !1, "0px", o));
                            return o;
                        },
                        prefix: !0,
                    ...
                    yt("backgroundPosition", {
                        ...
                        parser: function (t, e, i, n, s, o) {
                            ...
                            if ((-1 !== g.indexOf("%")) != (-1 !== _.indexOf("%")) && (f = G(t, "backgroundImage").replace(C, "")) && "none" !== f) {
                                for (a = g.split(" "), l = _.split(" "), B.setAttribute("src", f), u = 2; --u > -1; )
                                    (g = a[u]),
                                        (h = -1 !== g.indexOf("%")) !== (-1 !== l[u].indexOf("%")) &&
                                            ((c = 0 === u ? t.offsetWidth - B.width : t.offsetHeight - B.height), (a[u] = h ? (parseFloat(g) / 100) * c + "px" : (parseFloat(g) / c) * 100 + "%"));
                                g = a.join(" ");
                            }
                    ...
                    yt("margin", { parser: ft("marginTop,marginRight,marginBottom,marginLeft") }),
                    yt("padding", { parser: ft("paddingTop,paddingRight,paddingBottom,paddingLeft") }),
                    yt("clip", {
                    ...
                    yt("borderWidth", { parser: ft("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth") }),
                ...
                var Ft = function (t) {
                    ...
                    100 === r && (-1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"), (e = !G(this.data, "filter"))) : ((i.filter = n.replace(T, "")), (e = !0))),
                        e || (this.xn1 && (i.filter = n = n || "alpha(opacity=" + r + ")"), -1 === n.indexOf("pacity") ? (0 === r && this.xn1) || (i.filter = n + " alpha(opacity=" + r + ")") : (i.filter = n.replace(b, "opacity=" + r)));
                };
                        ...
                        return (
                            ...
                            q
                                ...
                                : ((s = new dt(l, "opacity", 100 * a, 100 * (e - a), s)),
                                  ...
                                  (s.plugin = o),
                                  (s.setRatio = Ft)),
                            u && ((s = new dt(l, "visibility", 0, 0, s, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")), (s.xs0 = "inherit"), n._overwriteProps.push(s.n), n._overwriteProps.push(i)),
                            s
                        );
                    },
                });
                ...
                var zt = function (t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        else for (e = this.e.split(" ").join("").split(","), n = e.length; --n > -1; ) (i = e[n]), l[i] && (l[i].parse === a ? (r = !0) : (i = "transformOrigin" === i ? St : l[i].p)), Bt(o, i);
                ...
                (u = o.prototype),
                    ...
                    (u._onInitTween = function (t, e, a) {
                        ...
                        var u,
                            ...
                            T = t.style;
                        if (
                            (c && "" === T.zIndex && ("auto" === (u = G(t, "zIndex", r)) || "" === u) && this._addLazySet(T, "zIndex", 0),
                            "string" == typeof e && ((g = T.cssText), (u = J(t, r)), (T.cssText = g + ";" + e), (u = K(t, u, J(t)).difs), !q && w.test(e) && (u.opacity = parseFloat(RegExp.$1)), (e = u), (T.cssText = g)),
                            ...
                            for (
                                b = 3 === this._transformType,
                                    wt
                                        ? f &&
                                          ((c = !0),
                                          "" === T.zIndex && ("auto" === (y = G(t, "zIndex", r)) || "" === y) && this._addLazySet(T, "zIndex", 0),
                        ...
                        for (o in e)
                            (p = e[o]),
                                ...
                                a
                                    ...
                                    : ((f = G(t, o, r) + ""),
                                      (g = "string" == typeof p),
                                      "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || (g && S.test(p))
                                          ? (g || ((p = ut(p)), (p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")")), (i = gt(v, o, f, p, !0, "transparent", i, 0, s)))
                                          : !g || (-1 === p.indexOf(" ") && -1 === p.indexOf(","))
                                          ? ((u = parseFloat(f)),
                                            (d = u || 0 === u ? f.substr((u + "").length) : ""),
                                            ("" === f || "auto" === f) &&
                                                ("width" === o || "height" === o ? ((u = it(t, o, r)), (d = "px")) : "left" === o || "top" === o ? ((u = Q(t, o, r)), (d = "px")) : ((u = "opacity" !== o ? 0 : 1), (d = ""))),
                                            (_ = g && "=" === p.charAt(1)),
                                            _ ? ((c = parseInt(p.charAt(0) + "1", 10)), (p = p.substr(2)), (c *= parseFloat(p)), (m = p.replace(x, ""))) : ((c = parseFloat(p)), (m = g ? p.replace(x, "") : "")),
                                            "" === m && (m = o in n ? n[o] : d),
                                            ...
                                            d !== m &&
                                                ...
                                                u &&
                                                ((u = Z(t, o, u, d)),
                                                "%" === m ? ((u /= Z(t, o, 100, "%") / 100), !0 !== e.strictUnits && (f = u + "%")) : "em" === m ? (u /= Z(t, o, 1, "em")) : "px" !== m && ((c = Z(t, o, c, m)), (m = "px")),
                                                _ && (c || 0 === c) && (p = c + u + m)),
                                            _ && (c += u),
                                            (!u && 0 !== u) || (!c && 0 !== c)
                                                ? void 0 !== v[o] && (p || ("NaN" != p + "" && null != p))
                                                    ? ((i = new dt(v, o, c || u || 0, 0, i, -1, o, !1, 0, f, p)), (i.xs0 = "none" !== p || ("display" !== o && -1 === o.indexOf("Style")) ? p : f))
                                                    : W("invalid " + o + " tween value: " + e[o])
                                                : ((i = new dt(v, o, u, c - u, i, 0, o, !1 !== h && ("px" === m || "zIndex" === o), 0, f, p)), (i.xs0 = m)))
                                          : (i = gt(v, o, f, p, !0, null, i, 0, s))),
                ...
                var Xt = function (t, e, i) {
                    var n, r, s, o;
                    if (t.slice) for (r = t.length; --r > -1; ) Xt(t[r], e, i);
                    else for (n = t.childNodes, r = n.length; --r > -1; ) (s = n[r]), (o = s.type), s.style && (e.push(J(s)), i && i.push(s)), (1 !== o && 9 !== o && 11 !== o) || !s.childNodes.length || Xt(s, e, i);
                };
                return (
        ...
        (function () {
            ...
            _gsScope._gsDefine.plugin({
                ...
                init: function (i, n) {
                    ...
                    for (r in n)
                        (this._start[r] = this._proxy[r] = s = i.getAttribute(r) + ""),
                            (this._end[r] = o = n[r] + ""),
                            (this._suffix[r] = a = e.test(o) ? o.replace(t, "") : e.test(s) ? s.replace(t, "") : ""),
                            a && -1 !== (l = o.indexOf(a)) && (o = o.substr(0, l)),
                            this._addTween(this._proxy, r, parseFloat(s), o, r) || (this._suffix[r] = ""),
                            "=" === o.charAt(1) && (this._end[r] = this._firstPT.s + this._firstPT.c + a),
            ...
            init: function (t, e) {
                ...
                for (i in e)
                    "useRadians" !== i &&
                        ...
                        a.length &&
                            ((n = a.join("_")),
                            -1 !== n.indexOf("short") && (o %= l) !== o % (l / 2) && (o = 0 > o ? o + l : o - l),
                            -1 !== n.indexOf("_cw") && 0 > o ? (o = ((o + 9999999999 * l) % l) - (0 | (o / l)) * l) : -1 !== n.indexOf("ccw") && o > 0 && (o = ((o - 9999999999 * l) % l) - (0 | (o / l)) * l)),
                        (o > 1e-6 || -1e-6 > o) && (this._addTween(t, i, r, r + o, i), this._overwriteProps.push(i)));
                return !0;
            },
            set: function (t) {
                var e;
                        ...
                        function (e) {
                            ...
                            for (
                                ...
                                (i = d ? Math.random() : (1 / c) * p),
                                    (n = g ? g.getRatio(i) : i),
                                    "none" === l ? (r = _) : "out" === l ? ((s = 1 - i), (r = s * s * _)) : "in" === l ? (r = i * i * _) : 0.5 > i ? ((s = 2 * i), (r = 0.5 * s * s * _)) : ((s = 2 * (1 - i)), (r = 0.5 * s * s * _)),
    ...
    (function (t, e) {
        ...
        if (!i.TweenLite) {
                        ...
                        if (0 === g && r)
                            for (
                                h = ("com.greensock." + e).split("."),
                                    c = h.pop(),
                                    f = l(h.join("."))[c] = this.gsClass = r.apply(r, o),
                                    s &&
                                        ((i[c] = f),
                                        "function" == typeof define && define.amd
                                            ...
                                            : "TweenMax" === e && "undefined" != typeof module && module.exports && (module.exports = f)),
                                    p = 0;
                                this.sc.length > p;
                                p++
                            )
            ...
            for (
                ...
                (s = n[r] + ",Power" + r), w(new x(null, null, 1, r), s, "easeOut", !0), w(new x(null, null, 2, r), s, "easeIn" + (0 === r ? ",easeNone" : "")), w(new x(null, null, 3, r), s, "easeInOut");
            ...
            _("Ticker", function (t, e) {
                var i,
                    ...
                    g = function (t) {
                        ...
                        a > d && (c += a - m),
                            ...
                            (u.time = (C - c) / 1e3),
                            (e = u.time - l),
                            (!i || e > 0 || !0 === t) && (u.frame++, (l += e + (e >= s ? 0.004 : s - e)), (o = !0)),
                            !0 !== t && (r = n(g)),
                ...
                T.call(u),
                    ...
                    (u.wake = function () {
                        null !== r ? u.sleep() : u.frame > 10 && (C = k() - d + 5),
                            (n =
                                0 === i
                                    ? f
                                    : p && S
            ...
            var R = _(
                                    ...
                                    s
                                        ? "string" != typeof s
                                            ? s.length && s !== t && s[0] && (s[0] === t || (s[0].nodeType && s[0].style && !s.nodeType))
                                                ...
                                                : ((this._siblings[r] = U(s, this, !1)), 1 === l && this._siblings[r].length > 1 && V(s, this, null, 1, this._siblings[r]))
                ...
                N = function (t, e) {
                    var i,
                        n = {};
                    for (i in t)
                        H[i] || (i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i) || !(!I[i] || (I[i] && I[i]._autoCSS)) || ((n[i] = t[i]), delete t[i]);
                    t.css = n;
                };
            (s = R.prototype = new O()),
                (s.constructor = R),
                ...
                (R.version = "1.17.0"),
                (R.defaultEase = s._ease = new x(null, null, 1, 1)),
            ...
            var M = [],
                j = {},
                L = (R._internals = { isArray: p, isSelector: D, lazyTweens: M }),
                I = (R._plugins = {}),
                F = (L.tweenLookup = {}),
                B = 0,
                H = (L.reservedProps = {
            ...
            var U = function (t, e, i) {
                    var n,
                        r,
                        s = t._gsTweenID;
                    if ((F[s || (t._gsTweenID = s = "t" + B++)] || (F[s] = { target: t, tweens: [] }), e && ((n = F[s].tweens), (n[(r = n.length)] = e), i))) for (; --r > -1; ) n[r] === e && n.splice(r, 1);
                    return F[s].tweens;
                },
                Y = function (t, e, i, n) {
                    var r,
            ...
            (s._init = function () {
                ...
                if (
                    ((this._ease = u = u ? (u instanceof x ? u : "function" == typeof u ? new x(u, s.easeParams) : b[u] || R.defaultEase) : R.defaultEase),
                ...
                (s._initProps = function (e, i, n, r) {
                    ...
                    for (s in this.vars) {
                        if (((h = this.vars[s]), H[s])) h && (h instanceof Array || (h.push && p(h))) && -1 !== h.join("").indexOf("{self}") && (this.vars[s] = h = this._swapSelfInParams(h, this));
                            ...
                            for (this._firstPT = u = { _next: this._firstPT, t: l, p: "setRatio", s: 0, c: 1, f: !0, n: s, pg: !0, pr: l._priority }, o = l._overwriteProps.length; --o > -1; ) i[l._overwriteProps[o]] = this._firstPT;
                            (l._priority || l._onInitAllProps) && (a = !0), (l._onDisable || l._onEnable) && (this._notifyPluginsOfEnabled = !0);
                        } else
                            (this._firstPT = i[s] = u = { _next: this._firstPT, t: e, p: s, f: "function" == typeof e[s], n: s, pg: !1, pr: 0 }),
                    ...
                    return r && this._kill(r, e)
                        ...
                        : (this._firstPT && ((!1 !== this.vars.lazy && this._duration) || (this.vars.lazy && !this._duration)) && (j[e._gsTweenID] = !0), a);
                }),
                (s.render = function (t, e, i) {
                    var n,
                        r,
                    ...
                    if (t >= l)
                        (this._totalTime = this._time = l),
                            ...
                            0 === l &&
                                ...
                                (0 === t || 0 > u || (u === h && "isPause" !== this.data)) && u !== t && ((i = !0), u > h && (r = "onReverseComplete")),
                                (this._rawPrevTime = o = !e || t || u === t ? t : h));
                    else if (1e-7 > t)
                        (this._totalTime = this._time = 0),
                            (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
                            (0 !== a || (0 === l && u > 0)) && ((r = "onReverseComplete"), (n = this._reversed)),
                            0 > t && ((this._active = !1), 0 === l && (this._initted || !this.vars.lazy || i) && (u >= 0 && (u !== h || "isPause" !== this.data) && (i = !0), (this._rawPrevTime = o = !e || t || u === t ? t : h))),
                            this._initted || (i = !0);
                ...
                (R.delayedCall = function (t, e, i, n, r) {
                    return new R(e, 0, { delay: t, onComplete: e, onCompleteParams: i, callbackScope: n, onReverseComplete: e, onReverseCompleteParams: i, immediateRender: !1, lazy: !1, useFrames: r, overwrite: 0 });
                }),
                (R.set = function (t, e) {
                    return new R(t, 0, e);
                }),
            ...
            if (
                ...
                (s._addTween = function (t, e, i, n, r, s) {
                    var o, a;
                    return null != n && (o = "number" == typeof n || "=" !== n.charAt(1) ? Number(n) - Number(i) : parseInt(n.charAt(0) + "1", 10) * Number(n.substr(2)))
        ...
        return (function () {
            ...
            return (
                (i.extend = function (i) {
                    ...
                    for (var o in i)
                        s[o] =
                            "function" == typeof i[o] && "function" == typeof r[o] && e.test(i[o])
                                ? (function (t, e) {
                                      return function () {
                                          var i = this._super;
                                          this._super = r[t];
    ...
    define("util/anim_frame", ["config", "underscore", "backbone"], function (t, e, i) {
        ...
        return (
            ...
            (n.on = function (t, e, n) {
                var r = 0;
                this._events &&
                    this._events.anim_frame &&
                    this._events.anim_frame.forEach(function (t) {
                        t.context && n && n.cid === t.context.cid && r++;
                    }),
                    i.Events.on.apply(this, arguments);
            }),
            n.onAnimRequestFrame(),
            n
        );
    }),
    define("preloader", ["events/app_events", "backbone", "TweenMax", "config", "util/class", "util/anim_frame"], function (t, e, i, n, r, s) {
        ...
        return r.extend({
            ...
            cnv: null,
            ctx: null,
            STARTING_PROGRESS: n.MOBILE ? 0.2 : 0.3,
            fauxPr: 0,
            fauxClipped: !1,
            init: function (t) {
                (this.el = document.getElementById("preloader")),
                    (this.inner = document.getElementsByClassName("js-loader-inner")[0]),
                    (this.barWrapper = document.getElementsByClassName("js-bar-wrapper")[0]),
                    (this.barProgress = document.getElementsByClassName("js-bar-progress")[0]),
                    (this.drop = document.getElementsByClassName("js-drop")[0]),
                    (this.cnv = document.createElement("canvas")),
                    (this.ctx = this.cnv.getContext("2d")),
                    (this.cnvDrop = document.createElement("canvas")),
                    (this.ctxDrop = this.cnvDrop.getContext("2d")),
            ...
            setDefault: function () {
                (this.isComplete = !1),
                    ...
                    (this.pr = 0),
                    (this.renderBar = !1),
                    (this.tweenObj = { bgMaskScaleXPr: 0, bgMaskScaleYPr: 0, alphaDropPr: 0, alphaBgPr: 0 }),
                    i.set([this.barWrapper, this.barProgress], { scaleX: 0 }),
                    i.to(this, 7, { fauxPr: this.STARTING_PROGRESS, ease: "Power1.easeInOut" });
            },
            start: function () {
                s.on("anim_frame", this.update, this), i.to(this.tweenObj, 0.64, { alphaBgPr: 1, delay: 0.23, ease: "Cubic.easeInOut" }), i.delayedCall(0.6, this.animateBgIn.bind(this));
            },
            complete: function () {
            ...
            animateBgIn: function () {
                (this.inner.style.opacity = 1),
                    i.to(this.tweenObj, 1, { alphaDropPr: 1, ease: "Cubic.easeInOut" }),
                    i.to(this.tweenObj, 0.7, { bgMaskScaleYPr: 1, ease: "Power2.easeIn", delay: 1 }),
                    i.to(this.tweenObj, 1.1, { bgMaskScaleXPr: 1, ease: "Expo.easeInOut", delay: 1.75, onComplete: this.onAnimBgComplete.bind(this) }),
                    i.delayedCall(1.75, this.animateBarIn.bind(this));
            },
            animateBarIn: function () {
                i.to(this.barWrapper, 1.15, { scaleX: 1, force3D: !0, ease: "Expo.easeInOut" });
            },
            animateBarOut: function () {
                e.trigger(t.Loader.PreHidden), i.to(this.drop, 0.62, { y: this.innerH, force3D: !0, ease: "Expo.easeIn" });
                var n = this;
                i.to(this.barWrapper, 0.79, { scaleX: 0, force3D: !0, ease: "Expo.easeInOut", delay: 0.144 }),
                    i.delayedCall(0.79, function () {
            ...
            drawBg: function () {
                ...
                (this.ctx.fillStyle = "rgb(" + n + "," + n + "," + n + ")"),
                    ...
                    this.ctx.fillRect(0.5 * (this.w - 1) - i, 0, 2 + this.w * t, this.h * e),
                    this.ctx.restore();
            },
            drawDrop: function () {
                var t = this.tweenObj.alphaDropPr;
                this.ctxDrop.clearRect(0, 0, this.cnvDrop.width, this.cnvDrop.height),
                    this.ctxDrop.save(),
                    (this.ctxDrop.globalAlpha = t),
                    this.ctxDrop.drawImage(this.dropImg, 0, 0, this.dropW, this.dropH),
                    this.ctxDrop.restore(),
                    this.ctx.drawImage(this.cnvDrop, Math.ceil(0.5 * (this.w - this.dropW)), 0.5 * (this.h - this.innerH), this.dropW, this.dropH);
            },
            drawBar: function () {
                i.set(this.barProgress, { scaleX: this.pr, force3D: !0 });
            },
            update: function () {
                this.updateProgress(), this.renderBar && (this.pr += 0.06 * (this.tgPr - this.pr)), this.drawBg(), this.drawBar();
                var t = this;
                1 === this.tgPr && this.pr > 0.99 && t.complete();
            },
            updateProgress: function () {
                window.loadProgress >= 0.95 && !this.fauxClipped && ((this.fauxClipped = !0), i.killTweensOf(this, { fauxPr: !0 }), i.to(this, 0.3, { fauxPr: this.STARTING_PROGRESS, ease: "Power1.easeInOut" })),
            ...
            onResize: function () {
                ...
                (this.w = window.innerWidth),
                    ...
                    (this.cnv.width = t * this.w),
                    (this.cnv.height = t * this.h),
                    (this.cnv.style.width = this.w + "px"),
                    (this.cnv.style.height = this.h + "px"),
                    this.ctx.scale(t, t),
                    (this.innerW = Math.min(0.6 * this.w, 500)),
                    (this.innerH = 0.1 * this.h),
                    (this.inner.style.left = Math.round(0.5 * (this.w - this.innerW)) + "px"),
                    (this.inner.style.top = Math.round(0.5 * (this.h - this.innerH)) + "px"),
                    (this.inner.style.width = this.innerW + "px"),
                    (this.inner.style.height = this.innerH + "px");
                var e = n.MOBILE ? 0.46 : 0.6;
    ...
    require.config({
        ...
        shim: {
            svgmorph: { exports: "MORPH" },
            "libs/console-shim": { exports: "console" },
            jquery: { exports: "jQuery" },
            sylvester: { exports: "$M" },
            "libs/createjs/movieclip": { deps: ["libs/createjs/easeljs", "libs/createjs/tweenjs"] },
            ...
            sea3d: { exports: "SEA3D", deps: ["three"] },
            sea3dLZMA: { exports: "SEA3DLZMA", deps: ["sea3d"] },
            sea3dLoader: { exports: "SEA3DLoader", deps: ["sea3d"] },
            cannon: { exports: "CANNON" },
            stats: { exports: "Stats" },
            three: { exports: "THREE" },
            "three/controls/OrbitControls": { exports: "OrbitControls", deps: ["three"] },
            "three/postprocessing/EffectComposer": { exports: "EffectComposer", deps: ["three", "three/postprocessing/MaskPass", "three/shaders/CopyShader", "three/postprocessing/ShaderPass"] },
            "shaders/ClearPass": { exports: "THREE.ClearPass", deps: ["three", "three/postprocessing/Pass"] },
            "shaders/ColourOffsetShader": { exports: "ColourOffsetShader", deps: ["three"] },
            "shaders/NoiseShader": { exports: "NoiseShader", deps: ["three"] },
            "shaders/BlendPass": { exports: "BlendPass", deps: ["three", "shaders/BlendShader"] },
            "shaders/BlendShader": { exports: "BlendShader", deps: ["three"] },
            "shaders/BasicBlurShader": { exports: "BasicBlurShader", deps: ["three"] },
            "shaders/PremultiplierShader": { exports: "PremultiplierShader", deps: ["three"] },
            "shaders/ChokeShader": { exports: "ChokeShader", deps: ["three"] },
            "three/postprocessing/ShaderPass": { exports: "ShaderPass", deps: ["three"] },
            "three/postprocessing/MaskPass": { exports: "MaskPass", deps: ["three"] },
            "three/postprocessing/RenderPass": { exports: "RenderPass", deps: ["three"] },
            "three/shaders/CopyShader": { exports: "CopyShader", deps: ["three"] },
            "three/shaders/BurnShader": { exports: "BurnShader", deps: ["three"] },
            "three/shaders/AdditiveBlendShader": { exports: "AdditiveBlendShader", deps: ["three"] },
            "three/shaders/ColorCorrectionShader": { exports: "ColorCorrectionShader", deps: ["three"] },
            "three/shaders/BrightnessContrastShader": { exports: "BrightnessContrastShader", deps: ["three"] },
            "three/shaders/FXAAShader": { exports: "FXAAShader", deps: ["three"] },
            objLoader: { deps: ["three"], exports: "OBJLoader" },
            ScrollTo: { deps: ["TweenMax"] },
        },
        waitSeconds: 0,
    }),
    ...
    require(["config", "preloader"], function (t, e) {
        ...
        var n = [],
            ...
            s = null;
        t.MOBILE
            ? ((t.FLOW = t.FLOWS.MOBILE), r.push(t.CDN + "/css/all_mobile.css"), n.push("main_mobile", "text!/index_mobile.html!strip"))
            : t.OLD_DESKTOP
            ? ((t.FLOW = t.FLOWS.BASIC), r.push(t.CDN + "/css/all.css"), n.push("main_desktop_extended", "text!/index_desktop.html!strip"))
            : t.TABLET
            ? ((t.FLOW = t.FLOWS.TABLET), r.push(t.CDN + "/css/all.css"), n.push("main_desktop_extended", "text!/index_desktop.html!strip"))
            : ((t.FLOW = t.FLOWS.EXTENDED), r.push(t.CDN + "/css/all.css"), n.push("main_desktop_extended", "text!/index_desktop.html!strip")),
            (function (t) {
        ...
        require([n.pop()], function (r) {
            (document.body.innerHTML = r),
                i(t.CDN + "/svg/spritemap.svg"),
                new e().init(),
                require(n, function (t) {
                    s
                        ? require(["tests/mocha"], function (e) {
                              t.start(), e.run(s);
                          })
                        : t.start();
                });
